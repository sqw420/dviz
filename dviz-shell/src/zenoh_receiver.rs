...
use dviz_core::zenoh_protocol::{MvizMessage, LogData, LogEntry, LogLevel, NodeDefinition, GraphUpdate, parse_message};
...
impl ZenohReceiver {
    ...
    pub fn start(connect_addr: Option<String>, topic_prefix: Option<String>) -> Self {
        ...
        let prefix = topic_prefix.unwrap_or_else(|| "dviz".to_string());
