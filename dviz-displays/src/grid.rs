...
impl GridDisplay {
    ...
    pub fn log_grid(&self, ctx: &DisplayUpdateContext) -> Result<(), dviz_rerun_bridge::RerunError> {
    ...
    pub fn initialize(&mut self, ctx: &DisplayUpdateContext) -> Result<(), dviz_rerun_bridge::RerunError> {
        self.dirty = true;
        self.update(ctx)
    }
