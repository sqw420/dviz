...
macro_rules! impl_display_base {
    ($type:ty) => {
        impl $type {
            ...
            /// Get current status
            pub fn status(&self) -> mviz_core::DisplayStatus {
            ...
            /// Set status
            pub fn set_status(&mut self, status: mviz_core::DisplayStatus, message: Option<String>) {
            ...
            /// Get display ID
            pub fn id(&self) -> mviz_core::DisplayId {
                self.base.id
            }

            /// Get properties
            pub fn properties(&self) -> &mviz_core::Properties {
                &self.base.properties
            }

            /// Get mutable properties
            pub fn properties_mut(&mut self) -> &mut mviz_core::Properties {
...
pub struct DisplayUpdateContext<'a> {
    ...
    pub transform_buffer: &'a mviz_transform::TransformBuffer,
    /// Fixed frame ID
    pub fixed_frame: &'a mviz_core::FrameId,
    /// Current time
    pub current_time: &'a mviz_core::Timestamp,
...
impl<'a> DisplayUpdateContext<'a> {
    ...
    pub fn new(
        ...
        transform_buffer: &'a mviz_transform::TransformBuffer,
        fixed_frame: &'a mviz_core::FrameId,
        current_time: &'a mviz_core::Timestamp,
        wall_dt: Duration,
    ) -> Self {
        Self {
            stream,
